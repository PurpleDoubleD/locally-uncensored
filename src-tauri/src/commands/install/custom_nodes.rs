...
//! gerufen.
//!
//! `is_permission_denied_pip_error` steht daneben, weil es dieselbe Stelle
//! rettet: eine python.org-Installation unter Program Files hat ein
//! Administrator-eigenes `site-packages`, und dort scheitert das erste Paket,
//! das ein NEUES Wheel zieht — während Pakete mit schon vorhandenen
