...
export const RELEASE_NOTES: ReleaseNote[] = [
  {
    ...
    lines: [
      ...
      'AMD on Windows is read from the HIP SDK, AMD on Linux reports its memory without ROCm and a compute card is visible at all, the Linux packages name the libraries they need, the ComfyUI installer checks the environment it built, LU reads the model folder you set, Document Chat works in Cloud mode, and the prompt history in Create can be cleared.',
    ],
    details: [
      {
        title: 'Local',
